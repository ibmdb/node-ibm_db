...
{
  var result;
  var dbInstance = new Database(options);
  var connectionOpen = dbInstance.openSync(connStr);
  ...
  else
  {
    ...
    else
    {
      ...
      // THEN: dbInstance.codeSet and dbInstance.mode will be "null" (default value).
      result = dbInstance.conn.createDbSync(dbName, dbInstance.codeSet, dbInstance.mode);
...
module.exports.dropDbSync = function (dbName, connStr, options)
{
  ...
  else
  {
    ...
    {
      result = dbInstance.conn.dropDbSync(dbName);
