...
Database.prototype.closeSync = function (cb) {
  var self = this;
  
  return self.conn.closeSync();
}
...
odbc.ODBCStatement.prototype.executeNonQuery = function (cb) {
  var self = this;
...
odbc.ODBCStatement.prototype.bind = function (ary, cb) {
  ...
  self.bindQueue.push(function (next) {
