...
odbc.ODBCStatement.prototype.executeNonQuery = function (params, cb) 
{
  ...
  self.queue.push(function (next) {
    ...
    if (params) 
    {
      ...
      exports.debug && console.log("%s odbc.js:executeNonQuery() bind params = ", getElapsedTime(), params);
      self._bind(params, function (err) {
        if (err) {
          if(!deferred) 
          {
...
odbc.ODBCStatement.prototype.bind = function (ary, cb) {
  ...
  self.bindQueue.push(function () {
    ...
    exports.debug && console.log("%s odbc.js:bind() params = ", getElapsedTime(), ary);
...
odbc.ODBCStatement.prototype.bindSync = function (ary) {
    ...
    exports.debug && console.log("%s odbc.js::bindSync() params = ", getElapsedTime(), ary);
...
module.exports.SQL_ATTR_QUERY_TIMEOUT = 0;
module.exports.SQL_ATTR_PARAM_BIND_TYPE = 18;
module.exports.SQL_ATTR_PARAMSET_SIZE = 22;
module.exports.SQL_ATTR_ROW_ARRAY_SIZE = 27;
