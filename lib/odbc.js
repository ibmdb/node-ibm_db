...
Database.prototype.query = function (query, params, cb)
{
  ...
  self.queue.push(function (next) {
    ...
    exports.debug && console.log("odbc.js:query() => %s", sql);
    if (params)
    {
      ...
      if(sql.search(/^call /i))  // Not a CALL satement
      {
        if(typeof query === 'object')
        {
          query.params = params;
...
Database.prototype.queryResult = function (query, params, cb)
{
  ...
  exports.debug && console.log("odbc.js:queryResult() => %s", sql);
  self.queue.push(function (next) {
...
Database.prototype.queryResultSync = function (query, params)
{
  ...
  exports.debug && console.log("odbc.js:queryResultSync() => %s", sql);
  if (params)
  {
    if(Array.isArray(params))
    {
...
Database.prototype.querySync = function (query, params)
{
  ...
  exports.debug && console.log("odbc.js:querySync() => %s", sql);
  if (params)
  {
    if(Array.isArray(params))
    {
